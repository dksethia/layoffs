...
const companies = [
    ...
    logo: "url",
    sus_scote: 0.9,
    description: "An amazing company where you can help build the website for watching cat videos.",
    website: "youtube.com",
...
const selectedCompanies = computed(() => 
    companies.filter(function (c) {
        if (selectedLocations.value.length == 0 || (selectedLocations.value.includes(c.location))) {
